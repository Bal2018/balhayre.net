  ...
  <body>
    ...
    <div class="editor">
        ...
        <form method="POST">
            ...
            <input type="text" name="title" class="title" title="title" value="<?= $isEdit ? $blogPost->title : "" ?>">
            <input type="hidden" name="id" value="<?= $isEdit ? $blogPost->id : null ?> ">
            <!-- Create a tag that we will use as the editable area. -->
            <!-- You can use a div tag as well. -->
            <textarea name="content" class="editor-content" title="content"><?= $isEdit ? $blogPost->contents : "" ?></textarea>
        ...
        <script type="text/javascript" src="/resource/js/RoadsterMate.js"></script>
        <script type="text/javascript" src="/resource/js/RizBlog.js"></script>
